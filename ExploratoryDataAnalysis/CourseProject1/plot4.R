...
par(mfrow = c(2,2))
plot(data$Time,data$GlobalActivePower,xlab="",ylab="Global Active Power",type="l")
...
plot(data$Time,data$GlobalReactivePower,xlab="",ylab="Global Reactive Power",type='l')
dev.off()